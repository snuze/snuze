...
/**
 * ControversialLinks defines the structure and parameters of a request to the
 * /r/[subreddit]/controversial API endpoint.
 *
 * This endpoint returns links from the specified subreddit, presented in the
 * "controversial" sort order.
 *
 * *****************************************************************************
 ...
 */
class ControversialLinks extends Links
{
    ...
    public function __construct(string $subredditName) {
        ...
        parent::__construct($subredditName, Links::SORT_CONTRO);
