...
/**
 * The Me request type defines the structure and parameters of a request to the
 * /api/v1/me API endpoint.
 *
 * This endpoint returns information about the currently authenticated API user.
 *
 * *****************************************************************************
...
class Me extends Request
{
    ...
    public function __construct() {
        ...
        /* Set endpoint path */
        $this->setEndpointPath('/api/v1/me');
    }
